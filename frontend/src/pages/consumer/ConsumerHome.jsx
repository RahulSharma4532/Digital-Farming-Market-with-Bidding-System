  ...
  return (
    <div className="min-h-screen bg-[#0f172a] text-white font-sans selection:bg-green-500 selection:text-white overflow-x-hidden">
      ...
      <div className="relative z-10 px-6 max-w-7xl mx-auto">
        ...
        {/* Hero Section */}
        <div className="pt-20 pb-32 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="relative w-full h-full transform rotate-y-[-10deg] rotate-x-[5deg] transform-style-3d">
                ...
                <motion.div
                  ...
                  className="absolute bottom-32 -left-10 bg-[#1e293b] p-4 rounded-2xl border border-white/10 shadow-xl flex items-center gap-3"
                >
                  <div className="bg-green-500/20 p-2 rounded-lg text-green-400">
                    <TrendingUp className="w-6 h-6" />
                  </div>
                  <div>
                    <p className="text-xs text-gray-400">Live Auctions</p>
                    <p className="text-lg font-bold text-white">Active Now</p>
                  </div>
                </motion.div>
                ...
                <motion.div
                  ...
                  className="absolute top-40 right-0 transform translate-x-1/2 bg-[#1e293b] p-4 rounded-2xl border border-white/10 shadow-xl flex items-center gap-3"
                >
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-white">Perfect for Delivery</p>
                  </div>
                </motion.div>
              </div>
            </motion.div>
        ...
        <div className="mt-12 mb-32 relative z-10">
          <div className="flex justify-between items-end mb-12">
            ...
            <button className="text-green-400 font-bold hover:text-green-300 flex items-center gap-2 transition-colors text-lg group">
